      ...
      <div className='bg-popGrey100 w-full min-h-screen flex flex-col place-content-center items-center text-sm text-popBlack700'>
        ...
        <div className='container max-w-xs xs:max-w-md bg-white rounded-xl p-6 xs:p-10 font-medium'>
          ...
          <div className='mt-6'>
            ...
            <div>
              <input className="bg-popGrey150 w-full rounded-lg py-3 px-2 text-base mt-2 border border-popRed400" type="text" placeholder="Email" />
              <div className="text-xxs text-popRed400">Error message is here</div>
            </div>
            <div className='mt-6'>
              <label>Password</label>
            </div>
            <div>
              <input className="bg-popGrey150 w-full rounded-lg py-3 px-2 text-base mt-2 border border-popRed400" type="text" placeholder="Password" />
              <div className="text-xxs text-popRed400">Error message is here</div>
            </div>
